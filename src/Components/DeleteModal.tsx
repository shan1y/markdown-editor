  ...
  return (
    <>
      ...
      <div className='center-modal-delete dark:bg-side-bkg bg-white p-24 max-w-["60px"]  rounded-lg'>
        ...
        <p className='dark:text-white text-icon-grey py-2 text-sm'>{`Are you sure you want to delete document: ${markdownTitle} and its contents? This action cannot be reverted.`}</p>
