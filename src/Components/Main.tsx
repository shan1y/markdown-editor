    ...
    <>
      ...
      <div className='flex relative bg-dark-bkg'>
        ...
        <div className={sidebar ? 'open-right' : 'close-right'} >
          ...
          {showMarkdown && <textarea className="p-4 h-screen border-none dark:bg-dark-bkg bg-white dark:text-white w-full outline-0 outline-0" value={markdown} onChange={(e) => { handleMarkdownChange(e) }}></textarea>}
